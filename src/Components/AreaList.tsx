...
import { getAreaList, searchByArea } from '../Redux/actions';
import america from '../Images/american-icon.png';
  ...
  return (
    <div className={styles.container}>
      <Carousel
        ...
        pagination={false}
      >
        {/* <img src={america} alt='he'/>
          <img src={require(`../Images/american-icon.png`)} alt={` flag`} className={styles.flag}/> */}
         {
